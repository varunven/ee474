 ...
 *   @date      22-May-2022
 *   @brief   Demo #5 of Lab 3
 *   
 *  Uses a DDS to run Task 4 continuously
 */
...
void schedule_sync();
TCB schedule_sync_TCB = { uuid++, "Syncs the scheduler", 0, TaskState::READY, 0, *schedule_sync};
void task4_sound();
TCB task4_sound_TCB = { uuid++, "Task 4 sound", 0, TaskState::READY, 0, *task4_sound};
void task4_countdown();
TCB task4_countdown_TCB = { uuid++, "Task 4 countdown", 0, TaskState::READY, 0, *task4_countdown};
...
/**
 * @brief Produces a sound for task 4
 * 
 * For 1 second, plays "Close Encounters of a Third Kind" theme song using a specific set of frequencies and displays said frequencies on the seg7 Display
 * 
 * @see sleep_474
 * @see task_self_quit
 * @see task_start
